...
Examples:
    Simple query:
    >>> from fitz_sage.runtime import run
    ...
    Check capabilities:
    >>> from fitz_sage.runtime import get_engine_registry
...
# =============================================================================
# Automatically discover and register engines from fitz_sage/engines/*/
...
def _discover_engines():
    ...
    This scans fitz_sage/engines/*/ and imports any module that:
    ...
    for engine_dir in engines_dir.iterdir():
        ...
        module_name = f"fitz_sage.engines.{engine_name}"
