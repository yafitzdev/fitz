...
Usage:
    from fitz_sage.vector_db import get_vector_db_plugin
...
from fitz_sage.core.utils import extract_path
...
def _string_to_uuid(s: str) -> str:
    ...
    """
    from fitz_sage.core.constants import UUID_NAMESPACE_DNS
...
def _get_vector_db_plugin_dirs() -> list[Path]:
    ...
    2. Package plugins (fitz_sage/vector_db/plugins/)
    """
...
def _get_auto_detected_kwargs(spec: VectorDBSpec, kwargs: Dict[str, Any]) -> Dict[str, Any]:
    ...
    detection function to call from fitz_sage.core.detect.
