...
_DISPUTED = (
    ...
    ("code", "function that applies volume discount", "apply_volume_discount", "discounts disabled"),
    ("code", "constant storing required API token environment variable", "FITZ_API_TOKEN", "FITZ_AUTH_TOKEN"),
    ("code", "method that refreshes expired sessions in grace window", "refresh_expired_session", "expired sessions are never refreshed"),
    ("code", "alert route for P2 search incidents", "route_p2_search_alert", "route_all_search_alerts_to_email"),
    ("code", "export scheduler method that skips unencrypted large exports", "skip_unencrypted_large_export", "allow_unencrypted_large_export"),
)


_INSUFFICIENT = (
    ("technology", "NimbusDB 4.2.3 ARM median write latency", "NimbusDB 4.2.1 x86 write latency", "12.4 ms"),
    ("technology", "OAuthClientV2 retry backoff cap in production", "OAuthClientV2 staging retry cap", "45 seconds"),
    ("technology", "Atlas feature flag expiry for EU", "Atlas feature flag owner", "Growth Platform"),
    ("technology", "LogStream parser error budget for v3", "LogStream parser v2 error budget", "0.25 percent"),
    ("technology", "TC-4812 retry owner after escalation", "TC-4812 initial reporter", "support desk"),
    ("law_policy", "Amber board guest export rule for external auditors", "Amber guest comment permissions", "comments allowed"),
    ("law_policy", "Cobalt CDN breach notice window for EU incidents", "Cobalt CDN uptime SLA", "99.95 percent"),
    ("law_policy", "biometric artifact retention after appeal", "password reset log retention", "90 days"),
    ("law_policy", "MeridianAI renewal notice in amended contract", "MeridianAI original notice", "75 days"),
    ("law_policy", "service account token rotation for break-glass accounts", "standard service account rotation", "45 days"),
    ("science_medicine", "Trial Zeta cohort B median response after week 12", "cohort A week 12 response", "18.4 percent"),
    ("science_medicine", "Lab assay L-22 storage temperature during transport", "in-lab storage temperature", "-80 C"),
    ("science_medicine", "Specimen batch RX-9 final exclusion reason", "preliminary exclusion flag", "review pending"),
    ("science_medicine", "Device D17 calibration interval after firmware 5", "firmware 4 calibration interval", "14 days"),
    ("science_medicine", "Study Maple final enrollment target", "draft enrollment target", "420 participants"),
    ("economics_finance", "Harborline April standard 30-year rate with zero points", "one discount point rate", "6.25 percent"),
    ...
    ("economics_finance", "Northwind CDN annual spend after renewal", "pre-renewal annual spend", "112000 USD"),
    ("economics_finance", "Q4 audited gross margin", "Q4 forecast gross margin", "63.2 percent"),
    ("history_geography", "Port Selene revised charter date", "original charter date", "1894-06-12"),
    ("history_geography", "Ridgeway census peak year after annexation", "pre-annexation census table", "1970"),
    ("history_geography", "Treaty of North Ford ratification city", "signing city", "Linden"),
    ("history_geography", "River Arno flood marker height at south gauge", "north gauge marker height", "3.7 meters"),
    ("history_geography", "Old Quarter temporary preservation zone", "permanent preservation zone", "Zone C"),
    ...
    ("culture_society", "Archive exhibit extended closing date", "original closing date", "2026-10-04"),
    ("culture_society", "Civic forum backup moderator", "main moderator", "Amina Kroll"),
    ("culture_society", "Library makerspace wheelchair-accessible capacity", "total capacity", "24 seats"),
    ("general", "warehouse WH-17 night-shift emergency contact", "day-shift emergency contact", "Mina Rao"),
    ("general", "support Gold Severity 0 response time", "Gold Severity 1 response time", "15 minutes"),
    ...
    ("general", "break-glass access duration for finance systems", "general break-glass duration", "4 hours"),
    ("code", "function that applies volume discount in billing v3", "billing v2 method", "apply_volume_discount"),
    ("code", "constant storing OAuth refresh token environment variable", "API token variable", "FITZ_API_TOKEN"),
    ("code", "method that refreshes expired admin sessions", "user session refresh method", "refresh_expired_session"),
    ("code", "alert route for P1 search incidents", "P2 search route", "route_p2_search_alert"),
    ("code", "export scheduler method that skips encrypted large exports", "unencrypted large export guard", "skip_unencrypted_large_export"),
)
        ...
        cases.append(
            GovernanceCase(
                ...
                contexts=(
                    ...
                    _context(index * 10 + 1, "text", "primary_source_b", right_content, "conflict_b"),
                ),
